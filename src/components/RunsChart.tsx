    ...
    <div className="card p-5">
      ...
      <ResponsiveContainer width="100%" height={240}>
        <AreaChart data={data} margin={{ left: -18, right: 8, top: 4 }}>
          ...
          <XAxis dataKey="label" tick={{ fontSize: 11, fill: 'rgb(var(--faint))' }} interval={3} tickLine={false} axisLine={false} />
          <YAxis tick={{ fontSize: 11, fill: 'rgb(var(--faint))' }} tickLine={false} axisLine={false} width={40} />
